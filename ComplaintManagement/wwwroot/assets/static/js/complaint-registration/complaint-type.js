        ...
        return {
            init: function () {
                ...
                var oTable = $('#editabledatatable').dataTable({
                    ...
                    "aoColumns": [
                        { "data": "complaint_name", "autoWidth": true, "sDefaultContent": "n/a" },
                ...
                function editRow(oTable, nRow) {
                    ...
                    $('.modal-body #complaint_name').val(json["complaint_name"]);
                ...
                $('#editabledatatable').on("click", 'a.delete', function (e) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            var parameters = { module: 'complaint_type_record', id: rec };
                            $.ajax({
...
$('#save').click(function () {
    ...
    var complaint_name = document.getElementById('complaint_name').value;
    ...
    $.ajax({
        url: "/ComplaintManagement/CreateComplaintType",
        type: "POST",
        data: parameters,
        beforeSend: function () {
            if (!$(a).hasClass("panel-loading")) {
