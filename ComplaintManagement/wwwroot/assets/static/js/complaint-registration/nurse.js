        ...
        return {
            init: function () {
                ...
                function editRow(oTable, nRow) {
                    ...
                    $('.modal-body #gender').val(json["gender"]).trigger("change");
                ...
                $('#editabledatatable').on("click", 'a.delete', function (e) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            var parameters = { module: 'nurse_record', id: rec };
                            $.ajax({
...
function GetNurse() {
    $.get('GetRecords', { module: 'nurse_record' }, function (data) {
...
$('#save').click(function () {
    ...
    $.ajax({
        url: "/HealthManagement/CreateNurse",
        type: "POST",
        data: parameters,
        beforeSend: function () {
            if (!$(a).hasClass("panel-loading")) {
