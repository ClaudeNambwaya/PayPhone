        ...
        return {
            init: function () {
                ...
                var oTable = $('#editabledatatable').dataTable({
                    ...
                    "aoColumns": [
                        { "data": "status_name", "autoWidth": true, "sDefaultContent": "n/a" },
                ...
                function editRow(oTable, nRow) {
                    ...
                    $('.modal-body #status_name').val(json["status_name"]);
                ...
                $('#editabledatatable').on("click", 'a.delete', function (e) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            var parameters = { module: 'statuses_record', id: rec };
                            $.ajax({
...
function GetStatus() {
    $.get('GetRecords', { module: 'statuses_record' }, function (data) {
...
$('#save').click(function () {
    ...
    $.ajax({
        url: "/ComplaintManagement/CreateStatus",
        type: "POST",
        data: parameters,
        beforeSend: function () {
            if (!$(a).hasClass("panel-loading")) {
