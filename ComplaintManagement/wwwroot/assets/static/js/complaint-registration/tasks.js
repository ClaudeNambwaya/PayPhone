        ...
        return {
            init: function () {
                ...
                function editRow(oTable, nRow) {
                    ...
                    $('.modal-body #client_type').val($(nRow).attr("client_type"));
                    $('.modal-body #matter_name').val(json["matter_name"]);
                    $('.modal-body #matter_number').val(json["matter_number"]);
                    $('.modal-body #user_id').val(json["assigned_user"]).trigger("change");
                    $('.modal-body #client_id').val(json["client"]).trigger("change");
                ...
                $('#editabledatatable').on("click", 'a.delete', function (e) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            var parameters = { module: 'matters', id: rec };
                            $.ajax({
                                url: "Delete/ClientManagement",
                                type: "GET",
                                data: parameters,
                                beforeSend: function () {
...
$('#save').click(function () {
    ...
    $.ajax({
        url: "CreateMatters/ClientManagement",
        type: "POST",
        data: parameters,
        beforeSend: function () {
            if (!$(a).hasClass("panel-loading")) {
