        ...
        return {
            init: function () {
                ...
                var oTable = $('#editabledatatable').dataTable({
                    ...
                    "aoColumns": [
                        { "data": "state_name", "autoWidth": true, "sDefaultContent": "n/a" },
                ...
                function editRow(oTable, nRow) {
                    ...
                    $('.modal-body #state_name').val(json["state_name"]);
                ...
                $('#editabledatatable').on("click", 'a.delete', function (e) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            var parameters = { module: 'state_record', id: rec };
                            $.ajax({
...
function GetState() {
    $.get('GetRecords', { module: 'state_record' }, function (data) {
...
$('#save').click(function () {
    ...
    $.ajax({
        url: "/ComplaintManagement/CreateState",
        type: "POST",
        data: parameters,
        beforeSend: function () {
            if (!$(a).hasClass("panel-loading")) {
